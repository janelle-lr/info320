    ...
    <div className="request-form">
      <div className="main-content">
        ...
        <div className="dialogue-info">
          ...
          <p>Thank your for you request, our team will review your request shortly.<br />
          You can view approved flow requests on the wave information page.<br /> 
          For urgent issues please contact us on 03 440 0329.<br />
          </p>
